...
* History: array of Events. An Event has a Status field (an integer: 3 = crit, 2 = warn, 1 = norm) with a textual string representation; and a Time field. Most recent last.
